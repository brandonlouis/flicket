...
<head>
    ...
    <title>Update Ticket Type | flicket</title>
        ...
        <div class="content">
            <form method="POST" action="../../controllers/ticketType_contr.php?ticketTypeId=<?php echo $ticketTypeDetails['id']; ?>" enctype="multipart/form-data" style="width:45%">
                ...
                <div class="input-group mt-4">
                    ...
                    <input type="text" class="form-control" id="name" name="name" placeholder="Name" value="<?php echo $ticketTypeDetails['name']; ?>" required>
                </div>
                <div class="input-group mt-3">
                    ...
                    <textarea class="form-control" placeholder="Description" id="description" name="description" style="height: 100px" required><?php echo $ticketTypeDetails['description']; ?></textarea>
                ...
                <div class="input-group mt-3">
                    ...
                    <input type="number" class="form-control" id="price" name="price" placeholder="Price (e.g. 19.99)" pattern="^\d{1,4}(?:\.\d{1,2})?$" step="0.01" min="0" max="999.99" value="<?php echo $ticketTypeDetails['price']; ?>" required>
                </div>
                <div class="d-flex">
                    <button type="submit" name="updateTicketType" class="btn btn-danger my-4 me-3">Update ticket type</button>
