        ...
        <div class="content d-flex justify-content-evenly align-items-center">
            <form method="POST" action="../../controllers/deal_contr.php" enctype="multipart/form-data" class="w-50">
                ...
                <div class="input-group mt-3">
                    ...
                    <input type="text" class="form-control bg-dark-subtle" id="fnbItem" name="fnbItem" placeholder='F&B items (select using dropdown)' required onclick="this.blur();" onkeydown="return false;">
                ...
                <div class="d-flex">
                    <button type="submit" name="createDeal" class="btn btn-danger my-4 me-3">Create Deal item</button>
