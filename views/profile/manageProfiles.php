        ...
        <div class="content">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="d-flex">
                    ...
                    <a href="createProfile.php" type="submit" class="btn btn-success bi bi-person-plus fs-3 ms-4" title="Create Account"></a>
                </div>
            </div>
            <table class="table table-hover text-white mt-4">
                ...
                <tbody class="align-middle">
                    ...
                    <tr <?php if (!$profile['userType']) { ?> class="text-danger" title="WARNING: Account does not have a User Type" <?php } ?>>
                        <td><?php echo $profile['userType']; ?></td>
                        <td><?php echo $profile['description']; ?></td> 
                        <td><?php echo $profile['accessType']; ?></td> 
                        <td class="d-flex justify-content-evenly">
                            <a href="updateProfile.php?userType=<?php echo $profile['userType']; ?>" type="submit" class="btn btn-outline-info bi bi-pencil fs-5" title="Edit Account"></a>
                            <button type="button" href="#" class="btn btn-danger bi bi-person-slash fs-5" title="Delete Account" data-bs-toggle="modal" data-bs-target="#delete<?php echo $profile['userType']; ?>"></button>
                        </td>
                    </tr>
