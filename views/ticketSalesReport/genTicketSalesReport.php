...
<body class="d-flex flex-column h-100">
    ...
    <div class="container mt-4" style="margin-bottom: 80px">
        <div class="content">
            ...
            <form method="POST" action="../../controllers/ticketSales/genSessionTicketSales_contr.php" class="row">
                <div class="mb-3">
            ...
            <form method="POST" action="../../controllers/ticketSales/genDailyTicketSales_contr.php" class="row">
                <div class="mb-3">
            ...
            <form method="POST" action="../../controllers/ticketSales/genWeeklyTicketSales_contr.php" class="row">
                <div class="mb-3">
